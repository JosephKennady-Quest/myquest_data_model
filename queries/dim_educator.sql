...
-- ─────────────────────────────────────────────────────────────────────────────
-- Table    : dim_educator
-- Grain    : one row per educator (fan-out risk via centre_project)
-- Mode     : incremental
-- Source   : quest_rearch_production.users, quest_rearch_production.facilitator_details,
--            quest_rearch_production.centre_project, quest_rearch_production.projects,
--            quest_rearch_production.programs
...
SELECT
    ...
    -- certification_level is intentionally excluded until the destination
    -- schema includes a corresponding educator attribute.
